#!/usr/bin/env python3
"""Import AIM Problem Lists link metadata into the LemmaTrail catalog.
...
DEFAULT_USER_AGENT = "LemmaTrail metadata importer"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Import AIM Problem Lists link metadata into the LemmaTrail catalog."
    )
    parser.add_argument(
        "--source-url",
