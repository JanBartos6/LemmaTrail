---
id: erdos-problem-1003
title: 'Erdos Problem #1003'
area: number-theory
status: open
source_ids:
- erdos-problems
...
- Tags: number theory
- Prize: none listed
- OEIS: [A001274](https://oeis.org/A001274) (linked)
- Formalization: [yes](https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/ErdosProblems/1003.lean); last update 2025-10-06
- Source status update: 2025-09-08
- Source comment: none

## Sources

- [Erdos Problem #1003](https://www.erdosproblems.com/1003) (database-record)
