---
id: erdos-problem-319
title: 'Erdos Problem #319'
area: number-theory
status: open
source_ids:
- erdos-problems
...
- Prize: none listed
- OEIS: none (possible)
- Formalization: [yes](https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/ErdosProblems/319.lean); last update 2025-08-31
- Source status update: 2025-08-31
- Source comment: none

## Sources

- [Erdos Problem #319](https://www.erdosproblems.com/319) (database-record)
