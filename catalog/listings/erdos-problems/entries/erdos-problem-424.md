---
id: erdos-problem-424
title: 'Erdos Problem #424'
area: number-theory
status: open
source_ids:
- erdos-problems
...
- Tags: number theory
- Prize: none listed
- OEIS: [A005244](https://oeis.org/A005244) (linked)
- Formalization: [yes](https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/ErdosProblems/424.lean); last update 2025-11-13
- Source status update: 2025-08-31
- Source comment: none

## Sources

- [Erdos Problem #424](https://www.erdosproblems.com/424) (database-record)
