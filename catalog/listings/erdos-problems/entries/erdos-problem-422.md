---
id: erdos-problem-422
title: 'Erdos Problem #422'
area: number-theory
status: open
source_ids:
- erdos-problems
...
- Tags: number theory
- Prize: none listed
- OEIS: [A005185](https://oeis.org/A005185) (linked)
- Formalization: [yes](https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/ErdosProblems/422.lean); last update 2025-11-11
- Source status update: 2025-08-31
- Source comment: none

## Sources

- [Erdos Problem #422](https://www.erdosproblems.com/422) (database-record)
