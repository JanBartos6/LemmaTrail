---
id: erdos-problem-394
title: 'Erdos Problem #394'
area: number-theory
status: open
source_ids:
- erdos-problems
...
- Tags: number theory
- Prize: none listed
- OEIS: [A344005](https://oeis.org/A344005) (linked)
- Formalization: [yes](https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/ErdosProblems/394.lean); last update 2026-02-09
- Source status update: 2025-10-28
- Source comment: none

## Sources

- [Erdos Problem #394](https://www.erdosproblems.com/394) (database-record)
