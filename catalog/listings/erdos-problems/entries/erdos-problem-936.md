---
id: erdos-problem-936
title: 'Erdos Problem #936'
area: number-theory
status: open
source_ids:
- erdos-problems
...
- Tags: number theory
- Prize: none listed
- OEIS: [A146968](https://oeis.org/A146968) (possible)
- Formalization: [yes](https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/ErdosProblems/936.lean); last update 2025-08-31
- Source status update: 2025-08-31
- Source comment: none

## Sources

- [Erdos Problem #936](https://www.erdosproblems.com/936) (database-record)
