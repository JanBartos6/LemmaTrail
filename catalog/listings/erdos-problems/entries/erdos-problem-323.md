---
id: erdos-problem-323
title: 'Erdos Problem #323'
area: number-theory
status: open
source_ids:
- erdos-problems
...
- Prize: none listed
- OEIS: none (possible)
- Formalization: [yes](https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/ErdosProblems/323.lean); last update 2026-03-15
- Source status update: 2025-08-31
- Source comment: none

## Sources

- [Erdos Problem #323](https://www.erdosproblems.com/323) (database-record)
