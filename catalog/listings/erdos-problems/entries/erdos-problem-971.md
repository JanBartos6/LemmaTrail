---
id: erdos-problem-971
title: 'Erdos Problem #971'
area: number-theory
status: open
source_ids:
- erdos-problems
...
- Tags: number theory
- Prize: none listed
- OEIS: [A226521](https://oeis.org/A226521) (linked)
- Formalization: [yes](https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/ErdosProblems/971.lean); last update 2026-01-12
- Source status update: 2025-08-31
- Source comment: none

## Sources

- [Erdos Problem #971](https://www.erdosproblems.com/971) (database-record)
