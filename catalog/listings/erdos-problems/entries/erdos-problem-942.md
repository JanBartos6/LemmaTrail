---
id: erdos-problem-942
title: 'Erdos Problem #942'
area: number-theory
status: open
source_ids:
- erdos-problems
...
- Prize: none listed
- OEIS: none (possible)
- Formalization: [yes](https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/ErdosProblems/942.lean); last update 2025-08-31
- Source status update: 2025-08-31
- Source comment: none

## Sources

- [Erdos Problem #942](https://www.erdosproblems.com/942) (database-record)
