---
id: erdos-problem-536
title: 'Erdos Problem #536'
area: number-theory
status: open
source_ids:
- erdos-problems
...
- Prize: none listed
- OEIS: none (possible)
- Formalization: [yes](https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/ErdosProblems/536.lean); last update 2025-11-12
- Source status update: 2025-08-31
- Source comment: none

## Sources

- [Erdos Problem #536](https://www.erdosproblems.com/536) (database-record)
