---
id: erdos-problem-978
title: 'Erdos Problem #978'
area: number-theory
status: open
source_ids:
- erdos-problems
...
- Prize: none listed
- OEIS: none (possible)
- Formalization: [yes](https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/ErdosProblems/978.lean); last update 2026-01-20
- Source status update: 2025-08-31
- Source comment: none

## Sources

- [Erdos Problem #978](https://www.erdosproblems.com/978) (database-record)
