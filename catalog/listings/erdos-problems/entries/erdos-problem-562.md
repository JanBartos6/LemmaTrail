---
id: erdos-problem-562
title: 'Erdos Problem #562'
area: graph-theory
status: open
source_ids:
- erdos-problems
...
- Prize: none listed
- OEIS: none (possible)
- Formalization: [yes](https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/ErdosProblems/562.lean); last update 2025-12-30
- Source status update: 2025-08-31
- Source comment: none

## Sources

- [Erdos Problem #562](https://www.erdosproblems.com/562) (database-record)
